...
<head>
    ...
    <style>
        ...
        /* Efek Masking: Gambar memudar ke arah teks (Hanya sisi dalam, sisi luar tetap mentok solid) */
        .mask-to-left {
        ...
        /* Hilangkan scrollbar kalau form pop-up panjang */
        ...
        <section x-data="{ 
            ...
            <div class="flex flex-col justify-center px-8 md:pl-12 lg:pl-24 xl:pl-40 py-16">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('reservasi.tgl', ['paket' => 'Wedding']) }}" class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-md active:scale-95">
                        Pilih Paket
                    </a>
                </div>
            </div>
        ...
        <section x-data="{ 
            ...
            <div class="flex flex-col justify-center items-start md:items-end text-left md:text-right px-8 md:pr-12 lg:pr-24 xl:pr-40 py-16 order-1 md:order-2">
                ...
                <div class="flex flex-row-reverse items-center gap-6 justify-end">
                    <a href="{{ route('reservasi.tgl', ['paket' => 'Intimate Wedding']) }}" class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-md active:scale-95">
                        Pilih Paket
                    </a>
        ...
        <section x-data="{ 
            ...
            <div class="flex flex-col justify-center px-8 md:pl-12 lg:pl-24 xl:pl-40 py-16">
                ...
                <div class="flex items-center gap-6">
                    ...
                    <a href="{{ route('reservasi.tgl', ['paket' => 'Akad Nikah']) }}" class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-md active:scale-95">
                        Pilih Paket
                    </a>
                </div>
            </div>
